                    ...
                    builder.setNegativeButton("Booked", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(edittext.getText().toString()==null){
                                ...
                                myRef.child("user-booked-slots").child(plazaName).child(String.valueOf(position)).setValue(new Slot_ReservationModel(sdf.format(myCalendar.getTime()).toString(), size, sizee, String.valueOf(System.currentTimeMillis()),plazaName, slot_viewModelArrayList.get(position).getSlot_no(), true, mAuth.getCurrentUser().getEmail().toString()));
