                        ...
                        mAuth.createUserWithEmailAndPassword((email.getText().toString()), (password.getText().toString())).addOnCompleteListener(getActivity(),
                                new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        firebase.child("users").child(uid).setValue(new UserModels(email.getText().toString(),pass,confrim_passwordd,uid,fname.getText().toString(),lname.getText().toString()));
